...
class Smarty extends Smarty_Internal_TemplateBase
{
     ...
     */
    public static $_muted_directories = array(APPPATH.'/cache/smarty/compiled/' => null, APPPATH.'/cache/smarty/cache/' => null);
     ...
     * @var string
     */
    private $compile_dir = APPPATH.'/cache/smarty/compiled/';
     ...
     * @var string
     */
    private $cache_dir = APPPATH.'/cache/smarty/cache/';
    ...
    public function __construct()
    {
        ...
        if ($this->compile_dir !== APPPATH.'/cache/smarty/compiled/') {
            unset(self::$_muted_directories[APPPATH.'/cache/smarty/compiled/']);
            $this->setCompileDir($this->compile_dir);
        }
        if ($this->cache_dir !== APPPATH.'/cache/smarty/cache/') {
            unset(self::$_muted_directories[APPPATH.'/cache/smarty/cache/']);
